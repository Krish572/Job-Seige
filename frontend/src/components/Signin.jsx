...
<<<<<<< HEAD
          <span className="flex flex-col w-full gap-2">
            Password
            <input
              className="w-full py-3 sm:py-4 bg-white px-4 shadow-sm dark:bg-black rounded-md outline-none"
              type="password"
            />
          </span>
=======
...
>>>>>>> 4f03e602919416f1b421e9534226bcb412e09bb9
          ...
          <div className="flex flex-col w-full mt-2">
            <button className="cursor-pointer hover:bg-[#007CEF] bg-[#006ECF] py-3 sm:py-4 w-full rounded-md active:bg-[#00539C] text-white">
            ...
            {!isnew ? (
              <span className="text-[#5E5E5E]">
                No account?{" "}
                <span
                  className="text-[#2681D1]  cursor-pointer hover:text-[#007CEF]"
                  onClick={() => setIsnew((x) => !x)}
                >
                  Create one
                </span>
              </span>
