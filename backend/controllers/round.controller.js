...
async function createRound(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while creating Round " + err });
  }
}
...
async function getRounds(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while reading the rounds " + err });
  }
}
...
async function getRound(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while reading the round " + err });
  }
}
...
async function updateRound(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while updating the Round " + err });
  }
}
...
async function deleteRound(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while deleting the round " + err });
  }
}
